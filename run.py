...
# Not updated for a while, Model misses some arguments. Change to keyword arguments with **
...
#           affix_prior_l1=AFFIX_PRIOR_L1, affix_prior_l2=AFFIX_PRIOR_L2, steps=STEPS, interactions_per_step=INTERACTIONS_PER_STEP, run_id=0)
# stats_df = m.run()
# print(stats_df)

...
class Agent(Agent):
    def __init__(self, pos, model, data):
        ...
        self.lex_concepts = data.concepts
        ...
        self.affixes = copy.deepcopy(self.affixes)
    ...
    def listen(self, signal):
        ...
        prefix = signal.get_prefix()
        suffix = signal.get_suffix()
        context_subject = signal.get_context_subject()
        context_object = signal.get_context_object()
